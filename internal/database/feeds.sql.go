...
func (q *Queries) UpdateLastFetched(ctx context.Context, arg UpdateLastFetchedParams) error {
	_, err := q.db.ExecContext(ctx, updateLastFetched, arg.LastFetchedAt, arg.ID)
	return err
}
